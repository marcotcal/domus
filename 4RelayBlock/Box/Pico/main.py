...
if __name__ = "__main__":
    ...
    # Relays initial values (on Valemman relay block initially LOW)
    ...
    print("Connected to MQTT broker and topics subscribed")
